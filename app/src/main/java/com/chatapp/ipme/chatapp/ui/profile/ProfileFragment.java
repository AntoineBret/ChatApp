...
public class ProfileFragment extends Fragment {
  ...
  //Current
  private Integer user_ID = Chatapp.getCurrentUserID();
  ...
  public void sendNewUserData() {
    ...
    apiInterface.editUser(SessionHashMap.getNewUserDataMap(), user_ID)
  ...
  private void checkAndUpdateData() {
    if (!updated_username.equals(current_username) && (!updated_username.equals(null))) {
      SessionCreator.editUsername(updated_username);
    } else if (!updated_firstname.equals(current_firstname) && (!updated_firstname.equals(null))) {
      SessionCreator.editFirstname(updated_firstname);
    } else if (!updated_lastname.equals(current_lastname) && (!updated_lastname.equals(null))) {
      SessionCreator.editFirstname(updated_lastname);
    } else if (!updated_email.equals(current_email) && (!updated_email.equals(null))) {
      SessionCreator.editFirstname(updated_email);
    } else if (!updated_birthday.equals(current_birthday) && (!updated_birthday.equals(null))) {
