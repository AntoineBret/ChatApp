...
public class SessionManager {
  ...
  private static String PREF_NAME = "com.sketchproject.infogue";
...
//  public static final String REGISTRATION_COMPLETE;
  ...
  public boolean createLoginSession(HashMap<String, Object> session) {
    ...
    editor.putString(KEY_FIRSTNAME, String.valueOf(session.get(KEY_FIRSTNAME)));
    editor.putString(KEY_LASTNAME, String.valueOf(session.get(KEY_LASTNAME)));
    editor.putString(KEY_EMAIL, String.valueOf(session.get(KEY_EMAIL)));
